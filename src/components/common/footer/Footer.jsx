        ...
        <div className='container padding'>
          ...
          <div className='box link'>
            ...
            <ul>
              ...
              <li>Script & Screenplay Writing</li>
              <li>Audio & Sound Engineering</li>
              <li>Film Sound Recording Audio Post Production</li>
              <li>Classical & Playback Singing</li>
              <li>Acting & Presentation</li>
            </ul>
          </div>
